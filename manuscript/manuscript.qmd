...
The fundamental question is: when is using aviation to fight fire worth the cost. The answer depends on the objectives of the mission, which aircraft are conducting the mission, and tactically where on the fire aviation is used in relation to other suppression activities. The AFUE report provides the best available information on the effectiveness of aviation resources in accomplishing stated objectives. It finds that across all types of aviation, there is an 82% success rate in accomplishing mission objectives.
