...
-   Cost Benefit analysis
    ...
    -   We know the cost of aviation because the gov pays the bills. The benefits are hard to quantify because we don't observe the fires that are contained

    -   In econometric terms, aviation is endogenous and not randomly assigned to fires. So, aviation is used on fires where it is expected to help. Moreover, it is used in areas where it is expected to reduce damage or slow the spread.

    -   Aviation has long been expected to work best on initial attack. However, aviation is increasingly used to support extend attack
